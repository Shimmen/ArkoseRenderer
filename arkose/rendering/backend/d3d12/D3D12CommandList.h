...
public:
    ...
    void copyTexture(Texture& src, Texture& dst, ImageFilter filter, u32 srcMip, u32 dstMip) override;
    ...
    void clearRenderTargetAttachment(RenderTarget::AttachmentType, Rect2D clearRect, ClearValue) override;
