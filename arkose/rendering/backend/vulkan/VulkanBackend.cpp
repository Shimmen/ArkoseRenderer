...
{
    return std::make_unique<VulkanRenderState>(*this, renderTarget, vertexLayout, shader, stateBindings, blendState, rasterState, depthState, stencilState);
}
...
void VulkanBackend::createFrameContexts()
{
    ...
    for (int i = 0; i < NumInFlightFrames; ++i) {
        ...
        {
            // TODO: Reduce this size, instead be smarter about how much we want to push, e.g. budget texture uploads per frame
            static constexpr size_t registryUploadBufferSize = 64 * 1024 * 1024;
