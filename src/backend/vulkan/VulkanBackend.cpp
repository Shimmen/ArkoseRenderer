...
void VulkanBackend::generateMipmaps(const Texture& genTexture, VkImageLayout finalLayout)
{
    ...
    ASSERT(texture.currentLayout != VK_IMAGE_LAYOUT_UNDEFINED);
    ...
    bool success = issueSingleTimeCommand([&](VkCommandBuffer commandBuffer) {
        ...
        for (uint32_t i = 1; i < mipLevels; ++i) {
            ...
            VkImageLayout currentLayout = (i == 1) ? texture.currentLayout : VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL;
