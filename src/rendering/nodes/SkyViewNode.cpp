...
RenderPipelineNode::ExecuteCallback SkyViewNode::constructFrame(Registry& reg) const
{
    ...
    BindingSet& skyViewComputeBindingSet = reg.createBindingSet({ { 0, ShaderStageCompute, reg.getBuffer("SceneCameraData") },
    ...
    BindingSet& skyViewRasterizeBindingSet = reg.createBindingSet({ { 0, ShaderStageVertex, reg.getBuffer("SceneCameraData") },
